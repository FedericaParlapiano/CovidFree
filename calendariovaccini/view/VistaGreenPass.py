...
class VistaGreenPass(QWidget):
    ...
    def __init__(self, appuntamento, parent = None):
        ...
        font_data_nascita1.setPointSize(12)
        ...
        font_data_nascita2.setPointSize(8)
        ...
        #data_nascita = datetime.strptime(appuntamento.data_appuntamento, '%Y-%m-%d')
        #str_data_nascita = str(data_nascita.strftime('%Y-%m-%d'))
        ...
        font_data_scadenza = label_data_scadenza.font()
        font_data_scadenza.setPointSize(12)
        font_data_scadenza.setFamily('Georgia')
        label_data_scadenza.setFont(font_data_scadenza)

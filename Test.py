...
class Test(unittest.TestCase):
    def setUp(self):
        ...
        self.appuntamento_tampone = AppuntamentoTampone(nome="Domenico", cognome="Ursino", cf="URSNDMNC0", telefono="071 567896", indirizzo="via Brecce Bianche", data_nascita="08/12/1995", data_appuntamento="02-07-2021", fascia_oraria="9:00-10:00", is_drive_through=True, tipo_tampone="Molecolare")
